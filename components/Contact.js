      ...
      >
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  ...
                  Ward No 9, Near Satnam Dhaba Athhoorwala Moldhar, Doiwala (Dehradun) Uttarakhand
                      </Link>
                  <p className="text-gray-600 text-sm">
                  Athhoorwala Moldhar, Doiwala  Pin- 248140
                        </p>
                      </div>
              </div>
            </motion.div>
        ...
        >
          <details className="bg-white rounded-xl shadow-lg overflow-hidden">
            <summary className="p-4 cursor-pointer text-gray-800 font-medium flex items-center">
            ...
            <div className="aspect-w-16 aspect-h-9 h-64">
              {/* <iframe 
                src="https://www.google.com/maps/place/Satnaam+Dhaba/@30.1672998,78.1411265,17z/data=!3m1!4b1!4m6!3m5!1s0x39093ad218e3957d:0x272317b6ca3ba9a6!8m2!3d30.1672999!4d78.1459974!16s%2Fg%2F11c7lkp4lg?hl=en&entry=ttu&g_ep=EgoyMDI1MDQwOC4wIKXMDSoASAFQAw%3D%3D"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
