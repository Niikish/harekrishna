  ...
  return (
    <footer className="bg-gray-900 text-white text-sm">
      ...
      <div className="container mx-auto px-2 py-6">
        ...
        />
              <h3 className="text-base font-bold pb-1">Hare Krishna Home Deccor & Developers</h3>
            </div>
    ...
    <Link href="https://www.youtube.com/@HareKrishnaDevelopers" target="_blank">
          ...
          <div>
            ...
            <ul className="space-y-1 text-gray-300">
              <li className="flex items-start gap-2">
                ...
                <span>Ward No 9, Near Satnam Dhaba Athhoorwala Moldhar, Doiwala (Dehradun) Uttarakhand</span>
              </li>
      ...
      {/* <div className="bg-gray-800 py-3">
        <div className="container mx-auto px-2 text-center text-gray-400 text-xs space-y-1">
          ...
          <p>© {new Date().getFullYear()} Hare Krishna Home Deccor & Developers. All rights reserved.</p>
        </div> */}
      {/* </div> */}
    </footer>
  );
